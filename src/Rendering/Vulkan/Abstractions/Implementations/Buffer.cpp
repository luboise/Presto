...
namespace Presto {
    ...
    void Buffer::createBufferVerbose(const VulkanDevice& device,
                                     VkDeviceSize size,
        ...
        vkGetBufferMemoryRequirements(logicalDevice, bufferOut,
                                      &memRequirements);
...
**/
    ...
    void Buffer::copyInto(CommandPool& command_pool, const Buffer& src,
