...
Pipeline* PipelineBuilder::createPipeline() {
    ...
    _vertexInput.pVertexAttributeDescriptions = _vertexAttributeDescs.data();
    ...
    auto* new_pipeline = new Pipeline(_device, _descriptorGroup, createInfo);
...
PipelineBuilder::PipelineBuilder(VulkanDevice& device, DescriptorGroup& group,
