...
void WindowsWindow::init(const WindowProperties& props) {
    ...
    // linking
    this->_windowPtr = (void*)glfwCreateWindow(
        (int)props.width, (int)props.height, props.title.c_str(), NULL, NULL);
...
void WindowsWindow::SetCallbacks() {
    ...
    glfwSetKeyCallback(
        (GLFWwindow*)this->_windowPtr, [](GLFWwindow* window, int keycode,
