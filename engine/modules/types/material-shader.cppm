export module presto.types.material:shader;

import presto.types.core;

export namespace Pr {

enum class ShaderDataType : Pr::uint8_t {
    SHORT,
    USHORT,
...
enum class ShaderDataSubType : Pr::uint8_t {
    SHORT,
    USHORT,
    INT,
    UINT,
...
/**
 * @brief  Returns the sub-type of a given ShaderDataType.
 */
constexpr ShaderDataSubType getShaderDataSubType(ShaderDataType data);

/**
 * @brief  Returns the compile-time size of a ShaderDataSubType.
 */
...
constexpr Pr::size_t SizeOfShaderType(ShaderDataType type) noexcept;
